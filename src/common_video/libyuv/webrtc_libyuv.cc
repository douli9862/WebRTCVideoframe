...
//                       src_chroma_width, src_chroma_height);  //del by zhixin.tang
...
//                       dst_chroma_width, dst_chroma_height);  //del by zhixin.tang
}
...
//                       src_u, src_uv_width,
//                       src_v, src_uv_width,
//                       src_uv_width, src_uv_height);  //del by zhixin.tang
